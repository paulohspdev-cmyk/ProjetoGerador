...
const GENERIC = `/controllers/generic.png?${ASSET_VERSION}`;

const BY_MODEL: Record<string, string> = {
  DSE8610: `/controllers/dse8610.png?${ASSET_VERSION}`,
  "DSE7320 MKII": `/controllers/dse7320.png?${ASSET_VERSION}`,
  DSE7320: `/controllers/dse7320.png?${ASSET_VERSION}`,
  DSE4520: `/controllers/dse4520.png?${ASSET_VERSION}`,
  "DSE4520 MKII": `/controllers/dse4520.png?${ASSET_VERSION}`,
  DSE6120: `/controllers/dse6120.png?${ASSET_VERSION}`,
  "DEEP SEA 6120": `/controllers/dse6120.png?${ASSET_VERSION}`,
  "DSE 6120": `/controllers/dse6120.png?${ASSET_VERSION}`,
  INTELILITE9: `/controllers/intelilite9.png?${ASSET_VERSION}`,
  "INTELILITE 9": `/controllers/intelilite9.png?${ASSET_VERSION}`,
  "COMAP INTELILITE 9": `/controllers/intelilite9.png?${ASSET_VERSION}`,
  INTELIMAINS150: `/controllers/intelimains150.png?${ASSET_VERSION}`,
  "INTELIMAINS 150": `/controllers/intelimains150.png?${ASSET_VERSION}`,
  "COMAP INTELIMAINS 150": `/controllers/intelimains150.png?${ASSET_VERSION}`,
};
